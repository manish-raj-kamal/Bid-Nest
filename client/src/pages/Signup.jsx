  ...
  return (
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-6 py-20">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[10%] left-[15%] w-[400px] h-[400px] rounded-full bg-accent/[0.04] blur-3xl" />
        <div className="absolute bottom-[10%] right-[10%] w-[300px] h-[300px] rounded-full bg-accent/[0.03] blur-3xl" />
      </div>
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-text-secondary mt-2">
            {step === 'register' ? 'Join the premium auction experience' : `Enter the OTP sent to ${email}`}
          </p>
        </div>
            ...
            <>
              <form onSubmit={handleRegisterSubmit} className="space-y-5">
                ...
                <label className="flex items-start gap-2 cursor-pointer">
                  <input type="checkbox" required className="w-4 h-4 mt-0.5 rounded border-border text-accent focus:ring-accent/20 accent-accent" />
                  <span className="text-xs text-text-secondary leading-relaxed">
                    I agree to the{' '}
                    <a href="#" className="text-accent font-medium">Terms of Service</a>{' '}
                    and{' '}
                    <a href="#" className="text-accent font-medium">Privacy Policy</a>
                  </span>
                </label>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              ...
              <div className="text-center mt-4 space-y-3">
                <button
                  ...
                  disabled={loading}
                  className="block w-full text-xs font-semibold text-accent transition-colors hover:text-accent-dark disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="block w-full text-xs text-text-secondary hover:text-text-primary transition-colors"
                >
                  Back to register
                </button>
              </div>
